    ...
    return (
        <div>
            ...
            <div className="container mx-auto p-6 bg-gradient-to-b from-blue-50 to-gray-200 min-h-screen">
                <h2 className="text-5xl font-extrabold mb-8 text-center text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-teal-500 animate-pulse">Yearbook</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
                    {yearbookData.map((classYear, index) => (
                        <YearCard key={index} year={classYear.year} members={classYear.members} />
                    ))}
                </div>
            </div>
